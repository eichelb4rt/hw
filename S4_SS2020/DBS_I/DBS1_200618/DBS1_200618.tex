...
\begin{task}
    \hfill\vspace{-5mm}
    \begin{enumerate}[label={(\alph*)}]
        \item \hfill\lstinputlisting[language=sql]{code/2a.txt}
        \item \hfill\lstinputlisting[language=sql]{code/2b.txt}
        \item \hfill\lstinputlisting[language=sql]{code/2c.txt}
    \end{enumerate}
\end{task}
\begin{task}
    \lstinputlisting[language=sql]{code/3.txt}
\end{task}
\end{document}