...
%----- tasks
\begin{task}
    (zum selbst Austesten siehe \texttt{aufgabe1.py})
    Abgerundete Ergebnisse: 862.3, 87.1, 7.2, 2.4, 0 (bzw. $-1.1 \cdot 10^{-13}$)
    \lstinputlisting[language = python]{code/aufgabe1.py}
\end{task}
